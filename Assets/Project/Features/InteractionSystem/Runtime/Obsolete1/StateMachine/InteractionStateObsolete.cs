...
namespace Project.InteractionSystem
{
	...
	{
		public InteractionDataObsolete.Settings data;
		...
		public InteractionStateObsolete(string name, InteractionStateType type, InteractionDataObsolete.Settings data) : base(needsExitTime: data.time > 0)
		{
			this.name = name;
			this.data = data;
			this.type = type;
